    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 py-12 bg-[#FFF5EC]">
        <div className="w-full max-w-sm">
          ...
          {/* Heading */}
          <h1 className="font-heading text-3xl text-brown mb-1">Create an account</h1>
          <p className="text-sm text-muted-foreground mb-8">
            Join Angela&apos;s Cakes and start ordering.
          </p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            {/* Confirm password */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="confirmPw" className="text-sm font-semibold text-brown">
                Confirm password
              </label>
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full h-11 pl-4 pr-11 rounded-lg border bg-white text-sm text-brown placeholder:text-muted-foreground/60 outline-none focus:ring-2 focus:ring-crimson/30 transition ${
                    confirmPw && confirmPw !== password
                      ? 'border-red-400 focus:border-red-400'
                      : 'border-stroke focus:border-crimson'
                  }`}
                />
                <button
                  type="button"
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <Link to="/login" className="text-crimson font-semibold hover:underline">
              Log in
            </Link>
          </p>
